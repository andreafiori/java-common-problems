...
public class PushRelabelTest {
    ...
    public void testPushRelabel1() {
        ...
        assertEquals(7, (long) PushRelabel.getMaximumFlow(exampleInput.capacities, exampleInput.source, exampleInput.sink));
    }
    ...
    public void testPushRelabel2() {
        ...
        assertEquals(23, (long) PushRelabel.getMaximumFlow(exampleInput.capacities, exampleInput.source, exampleInput.sink));
    }
}
