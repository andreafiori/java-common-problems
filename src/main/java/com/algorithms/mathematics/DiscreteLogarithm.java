...
public class DiscreteLogarithm {
    ...
    private static long getDiscreteLogarithm(HashMap<Long, Long> set, long s, long a, long p) {
        for (long i = 0; i < s; ++i) {
    ...
    private static void generateSet(long a, long b_1, long p, long s, HashMap<Long, Long> set) {
        set.clear();
        for (long i = 0; i < s; ++i) {
     ...
     */
    public static long countDiscreteLogarithm(final long a, final long b, final long p) {
